...
function Meta3bhk() {
  useEffect(() => {
    ...
    iframe.src = "/src/game/3bhk.html"; // Make sure this file exists and loads your 1BHK Phaser map
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-400">Loading 3BHK Metaverse...</p>
            </div>
          </div>
        </div>
